      ...
      function e(t) { const o = this; i(this, e), j(Object.getPrototypeOf(e.prototype), 'constructor', this).call(this), this.position = this.position.bind(this), D.push(this), this.history = [], this.setOptions(t, !1), x.modules.forEach((t) => { typeof t.initialize !== 'undefined' && t.initialize.call(o); }), this.position(); } return v(e, t), E(e, [{ key: 'getClass', value() { let t = arguments.length <= 0 || void 0 === arguments[0] ? '' : arguments[0], e = this.options.classes; return typeof e !== 'undefined' && e[t] ? this.options.classes[t] : this.options.classPrefix ? `${this.options.classPrefix}-${t}` : t; } }, {
        ...
        value() {
          if (typeof this.targetModifier === 'undefined') return a(this.target); if (this.targetModifier === 'visible') {
            ...
            var t = void 0, o = this.target; o === document.body ? (o = document.documentElement, t = {
              left: pageXOffset, top: pageYOffset, height: innerHeight, width: innerWidth
            }) : t = a(o); let i = getComputedStyle(o), n = o.scrollWidth > o.clientWidth || [i.overflow, i.overflowX].indexOf('scroll') >= 0 || this.target !== document.body, r = 0; n && (r = 15); var s = t.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - r, e = { width: 15, height: 0.975 * s * (s / o.scrollHeight), left: t.left + t.width - parseFloat(i.borderLeftWidth) - 15 }, f = 0; s < 408 && this.target === document.body && (f = -11e-5 * Math.pow(s, 2) - 0.00727 * s + 22.58), this.target !== document.body && (e.height = Math.max(e.height, 24)); const l = this.target.scrollTop / (o.scrollHeight - s); return e.top = l * (s - e.height - f) + t.top + parseFloat(i.borderTopWidth), this.target === document.body && (e.height = Math.max(e.height, 24)), e;
          }
        }
      }, { key: 'clearCache', value() { this._cache = {}; } }, { key: 'cache', value(t, e) { return typeof this._cache === 'undefined' && (this._cache = {}), typeof this._cache[t] === 'undefined' && (this._cache[t] = e.call(this)), this._cache[t]; } }, { key: 'enable', value() { let t = this, e = arguments.length <= 0 || void 0 === arguments[0] || arguments[0]; this.options.addTargetClasses !== !1 && p(this.target, this.getClass('enabled')), p(this.element, this.getClass('enabled')), this.enabled = !0, this.scrollParents.forEach((e) => { e !== t.target.ownerDocument && e.addEventListener('scroll', t.position); }), e && this.position(); } }, { key: 'disable', value() { const t = this; d(this.target, this.getClass('enabled')), d(this.element, this.getClass('enabled')), this.enabled = !1, typeof this.scrollParents !== 'undefined' && this.scrollParents.forEach((e) => { e.removeEventListener('scroll', t.position); }); } }, { key: 'destroy', value() { const t = this; this.disable(), D.forEach((e, o) => { e === t && D.splice(o, 1); }), D.length === 0 && s(); } }, { key: 'updateAttachClasses', value(t, e) { const o = this; t = t || this.attachment, e = e || this.targetAttachment; const i = ['left', 'top', 'bottom', 'right', 'middle', 'center']; typeof this._addAttachClasses !== 'undefined' && this._addAttachClasses.length && this._addAttachClasses.splice(0, this._addAttachClasses.length), typeof this._addAttachClasses === 'undefined' && (this._addAttachClasses = []); const n = this._addAttachClasses; t.top && n.push(`${this.getClass('element-attached')}-${t.top}`), t.left && n.push(`${this.getClass('element-attached')}-${t.left}`), e.top && n.push(`${this.getClass('target-attached')}-${e.top}`), e.left && n.push(`${this.getClass('target-attached')}-${e.left}`); const r = []; i.forEach((t) => { r.push(`${o.getClass('element-attached')}-${t}`), r.push(`${o.getClass('target-attached')}-${t}`); }), k(() => { typeof o._addAttachClasses !== 'undefined' && (m(o.element, o._addAttachClasses, r), o.options.addTargetClasses !== !1 && m(o.target, o._addAttachClasses, r), delete o._addAttachClasses); }); } }, {
        key: 'position',
        value() {
          let t = this, e = arguments.length <= 0 || void 0 === arguments[0] || arguments[0]; if (this.enabled) {
            this.clearCache(); const o = U(this.targetAttachment, this.attachment); this.updateAttachClasses(this.attachment, o); let i = this.cache('element-bounds', () => a(t.element)), n = i.width, r = i.height; if (n === 0 && r === 0 && typeof this.lastSize !== 'undefined') { const s = this.lastSize; n = s.width, r = s.height; } else this.lastSize = { width: n, height: r }; let h = this.cache('target-bounds', () => t.getTargetBounds()), d = h, p = C(V(this.attachment), { width: n, height: r }), u = C(V(o), d), c = C(this.offset, { width: n, height: r }), g = C(this.targetOffset, d); p = w(p, c), u = w(u, g); for (var m = h.left + u.left - p.left, v = h.top + u.top - p.top, y = 0; y < x.modules.length; ++y) {
              let b = x.modules[y], O = b.position.call(this, {
                left: m, top: v, targetAttachment: o, targetPos: h, elementPos: i, offset: p, targetOffset: u, manualOffset: c, manualTargetOffset: g, scrollbarSize: S, attachment: this.attachment
              }); if (O === !1) return !1; typeof O !== 'undefined' && typeof O === 'object' && (v = O.top, m = O.left);
            } var E = {
                page: { top: v, left: m },
                viewport: {
                  top: v - pageYOffset, bottom: pageYOffset - v - r + innerHeight, left: m - pageXOffset, right: pageXOffset - m - n + innerWidth
                }
              }, A = this.target.ownerDocument, T = A.defaultView, S = void 0; return T.innerHeight > A.documentElement.clientHeight && (S = this.cache('scrollbar-size', l), E.viewport.bottom -= S.height), T.innerWidth > A.documentElement.clientWidth && (S = this.cache('scrollbar-size', l), E.viewport.right -= S.width), ['', 'static'].indexOf(A.body.style.position) !== -1 && ['', 'static'].indexOf(A.body.parentElement.style.position) !== -1 || (E.page.bottom = A.body.scrollHeight - v - r, E.page.right = A.body.scrollWidth - m - n), typeof this.options.optimizations !== 'undefined' && this.options.optimizations.moveElement !== !1 && typeof this.targetModifier === 'undefined' && !(function () { let e = t.cache('target-offsetparent', () => f(t.target)), o = t.cache('target-offsetparent-bounds', () => a(e)), i = getComputedStyle(e), n = o, r = {}; if (['Top', 'Left', 'Bottom', 'Right'].forEach((t) => { r[t.toLowerCase()] = parseFloat(i[`border${t}Width`]); }), o.right = A.body.scrollWidth - o.left - n.width + r.right, o.bottom = A.body.scrollHeight - o.top - n.height + r.bottom, E.page.top >= o.top + r.top && E.page.bottom >= o.bottom && E.page.left >= o.left + r.left && E.page.right >= o.right) { let s = e.scrollTop, l = e.scrollLeft; E.offset = { top: E.page.top - o.top + s - r.top, left: E.page.left - o.left + l - r.left }; } }()), this.move(E), this.history.unshift(E), this.history.length > 3 && this.history.pop(), e && _(), !0;
          }
        }
      }, {
        key: 'move',
