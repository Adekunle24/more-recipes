...
(function (window) {
  ...
  String.fromCharCode(high + 0x10000) :
    ...
    disabledAncestor = addCombinator(
      elem => elem.disabled === true && ('form' in elem || 'label' in elem),
 ...
 */
  ...
  function matcherFromTokens(tokens) {
    let checkContext, matcher, j,
      ...
      matchAnyContext = addCombinator(elem => indexOf(checkContext, elem) > -1, implicitRelative, true),
 ...
 */
  ...
  jQuery.extend({
    ...
    when(singleValue) {
      ...
      if (remaining <= 1) {
        adoptValue(
          singleValue, master.done(updateFunc(i)).resolve, master.reject,
          !remaining
        );
